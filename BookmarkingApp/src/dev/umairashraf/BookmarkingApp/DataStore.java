...
public class DataStore {
    ...
    private static void loadUsers() {
        users[0] = UserManager.getInstance().createUser(1000,
            " user0@semanticsquare.com", "testx", "John", "M", Gender.MALE,
            UserType.USER);
    ...
    private static void loadMovies() {
        ...
        bookmarks[1][3] = BookmarkManager.getInstance().createMovie(3003, "",
            ...
            new String[] { "	Kaley Cuoco,Jim Parsons	Chuck Lorre,Bill" },
            new String[] { "	Prady	" }, MovieGenre.TV_SHOWS, 8.5);
        bookmarks[1][4] = BookmarkManager.getInstance().createMovie(3004, "",
            " 	Ikiru", 1952,
            new String[] { "	Takashi Shimura,Minoru Chiaki" },
            new String[] { "	Akira Kurosawa" }, MovieGenre.FOREIGN_MOVIES,
            8.5);
    }
    ...
    private static void loadBooks() {
        ...
        bookmarks[2][1] = BookmarkManager.getInstance().createBook(4001,
            "	Self-Reliance and Other Essays", 1993, "	Dover Publications",
            new String[] { "Ralph Waldo Emerson" }, BookGenre.PHILOSOPHY, 4.5);
        bookmarks[2][2] = BookmarkManager.getInstance().createBook(4002,
            "	Light From Many Lamps", 1988, "	Touchstone",
            new String[] { "Lillian Eichler Watson" }, BookGenre.PHILOSOPHY,
            5.0);
        bookmarks[2][3] = BookmarkManager.getInstance()
            .createBook(4003, "	Head First Design Patterns", 2004,
                "	O'Reilly Media", new String[] { "Eric Freeman",
                        "Bert Bates", "Kathy Sierra", "Elisabeth Robson" },
                BookGenre.TECHNICAL, 4.5);
        bookmarks[2][4] = BookmarkManager.getInstance().createBook(4004,
            "	Effective Java Programming Language Guide", 2007,
