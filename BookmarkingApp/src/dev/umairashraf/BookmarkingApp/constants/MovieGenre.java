package dev.umairashraf.BookmarkingApp.constants;
...
public class MovieGenre {
	...
	public static final String ANIME_AND_ANIMATION="Anim & Animation";
	public static final String GAY_AND_LESBIAN="Gay & Lesbian";
	public static final String CLASSIC_MOVIE_MUSCIALS="CLassic Movie Muscials";
	public static final String FAITH_AND_SPIRITUALITY="Faith & Sprituality";
	public static final String FOREGIN_ACTION_AND_ADVENTURE="Foregin Action & Adventure";
	public static final String FOREGIN_THRILLERS="Foregin Thrillers";
